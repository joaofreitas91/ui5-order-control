		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order Control",
									"targetURL": "#comlab2devordercontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devordercontrol-display": {
								"semanticObject": "comlab2devordercontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.ordercontrol",
									"url": sap.ui.require.toUrl("com/lab2dev/ordercontrol")
								}
							}
						}
					}
